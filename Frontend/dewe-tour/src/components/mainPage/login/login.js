...
function ModalLogin({show, hidden, user, userAdmin, showReg}) {

  function showModalReg(data1) {
    showReg(data1)
    hidden(false)
  }
  ...
  return (
    <>
      <Modal centered show={show} onEscapeKeyDown={() => hidden(false)} onHide={() => hidden(false)}>
